...
export const customer_facebook_login = 'customers/customer_facebook_login'
...
export const get_offer_astrologer = 'customers/get_offer_astrologer'
export const get_trending_astrologer = 'customers/get_trending_astrologer'
...
export const get_customer_blogs = 'blogs'
export const get_customer_testimonails = 'testimonials'
...
export const follow_astrologer = 'customers/follow_astrologer'
export const check_customer_following = 'customers/check_customer_following'
export const get_customer_gifts = 'customers/get_customer_gifts'
